...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        angle_text_string_upper_body = 'Neck : ' + str(int(neck_inclination)) + '  Torso : ' + str(int(torso_inclination))
        angle_text_string_lower_body = 'Upper Leg : ' + str(int(thigh_inclination)) + '  Lower Leg : ' + str(int(calf_inclination))
        angle_text_string_arms = 'Upper Arm : ' + str(int(upper_arm_inclination)) + '  Lower Arm : ' + str(int(lower_arm_inclination))

        # Determine whether good posture or bad posture.
        # The threshold angles have been set based on intuition.
        if 110 < neck_inclination < 130 \
            and 110 < torso_inclination < 130 \
            and 130 < thigh_inclination < 150 \
            and 140 < calf_inclination < 160 \
            and 150 < upper_arm_inclination < 170 \
            and 140 < lower_arm_inclination < 160:
            bad_frames = 0
            good_frames += 1
            ...
            cv2.putText(image, str(int(calf_inclination)), (landmark["LEFT"]["HEEL"]["x"] + 10, landmark["LEFT"]["HEEL"]["y"]), font, 0.9, light_green, 2)
            cv2.putText(image, str(int(upper_arm_inclination)), (l_elbow_x + 10, l_elbow_y), font, 0.9, light_green, 2)
            cv2.putText(image, str(int(lower_arm_inclination)), (l_wrist_x + 10, l_wrist_y), font, 0.9, light_green, 2)
            ...
            cv2.line(image, (landmark["LEFT"]["HEEL"]["x"], landmark["LEFT"]["HEEL"]["y"]), (l_knee_x, l_knee_y), green, 4)
            ...
            # cv2.line(image, (l_ankle_x, l_ankle_y), (l_knee_x, l_knee_y), red, 4)
            cv2.line(image, (landmark["LEFT"]["HEEL"]["x"], landmark["LEFT"]["HEEL"]["y"]), (l_knee_x, l_knee_y), red, 4)
